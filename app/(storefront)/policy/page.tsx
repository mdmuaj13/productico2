...
async function fetchPolicy(type: PolicyType): Promise<PolicyValue | null> {
  ...
  const json = (await res.json()) as ApiSuccess<{ type: string; value: PolicyValue }>;
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
        <div className="container mx-auto px-4 py-10 max-w-3xl">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            >
              <div className="font-semibold text-gray-900 dark:text-white">Terms</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Terms & conditions</div>
            </Link>
            ...
            >
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">Privacy policy</div>
            </Link>
            ...
            <Link
              ...
              className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/40 p-4 hover:shadow-sm transition"
            >
              <div className="font-semibold text-gray-900 dark:text-white">Refund</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Refund & returns</div>
            </Link>
          </div>
        </div>
      </div>
