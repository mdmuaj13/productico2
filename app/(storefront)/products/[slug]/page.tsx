        ...
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <section className="lg:col-span-7 space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-3 pt-2">
              <InfoCard icon={Truck} title="Fast delivery" desc="Quick dispatch and updates." />
              <InfoCard icon={RotateCcw} title="Easy returns" desc="Hassle-free policy (if applicable)." />
              <InfoCard icon={Headphones} title="Support" desc="We’re here to help you." />
            </div>
          </section>
